		...
		<div class="control-box">
			<fieldset>
					<table class="form-table">
						<tbody>
					<tr>
								<th scope="row"><label for="leadsquared-field-name-email">Field Type</label></th>
									<td>
										<select name="leadsquared-field-name-email" class="tg-name oneline" id="leadsquared-field-name-email">
										<option>--</option>
											<?php 
											$phone = lsq_search($decode_json, 'DataType', 'Email');
...
(function($){
    ...
    $(document).ready(function() {
        ...
        var $lsqfn = $('#leadsquared-field-name-email');
