		...
		<div class="control-box">
			<fieldset>
					<table class="form-table">
						<tbody>
					<tr>
								<th scope="row"><label for="leadsquared-field-name-tel">Field Type</label></th>
									<td>
										<select name="leadsquared-field-name-tel" class="tg-name oneline" id="leadsquared-field-name-tel" >
										<option>--</option>
											<?php 
...
(function($){
    ...
    $(document).ready(function() {
        ...
        var $lsqfn = $('#leadsquared-field-name-tel');
