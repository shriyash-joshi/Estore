...
<tbody>
	...
	<td><select name="leadsquared-field-name-date" class="tg-name oneline" id="leadsquared-field-name-date">
										<option>--</option>
											<?php 
											$phone = lsq_search($decode_json, 'DataType', 'Date');
...
(function($){
    ...
    $(document).ready(function() {
        ...
        var $lsqfn = $('#leadsquared-field-name-date');
