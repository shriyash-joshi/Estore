		...
		<div class="control-box">
			<fieldset>
					<table class="form-table">
						<tbody>
					<tr>
								<th scope="row"><label for="leadsquared-field-name-url">Field Type</label></th>
									<td>
										<select name="leadsquared-field-name-url" class="tg-name oneline" id="leadsquared-field-name-url">
										<option>--</option>
											<?php 
											$phone = lsq_search($decode_json, 'DataType', 'Website');
...
(function($){
    ...
    $(document).ready(function() {
        ...
        var $lsqfn = $('#leadsquared-field-name-url');
