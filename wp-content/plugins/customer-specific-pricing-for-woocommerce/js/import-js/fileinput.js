...
(function ($) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: wdm_csp_translation.fileSingle,
        filePlural: wdm_csp_translation.filePlural,
        browseLabel: wdm_csp_translation.browseLabel,
        removeLabel: wdm_csp_translation.removeLabel,
        removeTitle: wdm_csp_translation.removeTitle,
        cancelLabel: wdm_csp_translation.cancelLabel,
        cancelTitle: wdm_csp_translation.cancelTitle,
        uploadLabel: wdm_csp_translation.uploadLabel,
        uploadTitle: wdm_csp_translation.uploadTitle,
        msgSizeTooLarge: wdm_csp_translation.msgSizeTooLarge,
        msgFilesTooLess: wdm_csp_translation.msgFilesTooLess,
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>. Please retry your upload!',
        msgFileNotFound: wdm_csp_translation.msgFileNotFound,
        msgFileSecured: wdm_csp_translation.msgFileSecured,
        msgFileNotReadable: wdm_csp_translation.msgFileNotReadable,
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'An error occurred while reading the file "{name}".',
        msgInvalidFileType: wdm_csp_translation.msgInvalidFileType,
        msgInvalidFileExtension: wdm_csp_translation.msgInvalidFileExtension,
        msgValidationError: wdm_csp_translation.msgValidationError,
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: wdm_csp_translation.msgSelected,
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: 'Width of image file "{name}" must be at least {size} px.',
        msgImageHeightSmall: 'Height of image file "{name}" must be at least {size} px.',
        msgImageWidthLarge: 'Width of image file "{name}" cannot exceed {size} px.',
        msgImageHeightLarge: 'Height of image file "{name}" cannot exceed {size} px.',
        dropZoneTitle: wdm_csp_translation.dropZoneTitle,
    };
