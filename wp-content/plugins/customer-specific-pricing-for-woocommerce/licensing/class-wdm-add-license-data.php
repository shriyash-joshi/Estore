        ...
        public function displayLicenseStatus($status, $previousStatus)
        {
            if ($status !== false) {
                if ($status == VALID || $previousStatus == VALID) {
                    ?>
                    <span style="color:#008000;"><?php _e('Active', $this->pluginTextDomain);
                    ?></span>
                <?php
                } elseif ($status == EXPIRED || $previousStatus == EXPIRED) {
                    ?>
                    <span style="color:#ff0000;"><?php _e('Expired', $this->pluginTextDomain);
                    ?></span>
                <?php
                } else {
                    ?>
                    <span style="color:#ff0000;"><?php _e('Not Active', $this->pluginTextDomain) ?></span>
                <?php
                }
            }
