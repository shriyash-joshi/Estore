...
/**
 * This class is used to send mail to customer after successful enrollement.
 */
if (!class_exists('SchedulerEnrollmentEmail')) {
    class SchedulerEnrollmentEmail extends SchedulerEmail
    {
        ...
        */
        ...
        {
            parent::__construct('enrollment_successful');
        }

        /**
         * Returns default enrollment email template HTML.
         *
         * @return string Default Enrollment Email template HTML.
         */
        public static function returnDefaultEnrollmentEmailTemplate()
        {
            ob_start();
            ?>
            <div id="wrapper">
                        ...
                        <tr>
                            <td style="padding: 20px; border-radius: 6px !important;" align="center" valign="top">
                                <div id="content">
                                    ...
                                    <div style="font-family: Arial; font-size: 14px; line-height: 150%; text-align: left;">Thanks for showing interest in [product_title], You will receive a notification mail when the product becomes available on our site " [site_title] ".&nbsp;</div>
                                    <div style="font-family: Arial; font-size: 14px; line-height: 150%; text-align: left;"></div>
                                    <div style="font-family: Arial; font-size: 14px; line-height: 150%; text-align: left;">Happy Shopping till then <h3>[site_title]</h3></div>
                                    <div style="font-family: Arial; font-size: 14px; line-height: 150%; text-align: left;"></div>
                                </div>
                            </td>
                        </tr>
        ...
        /**
         * Returns CSS which will be applied to the default enrollment
         * successful email template.
         *
         * @return string Default CSS to be applied on the email template.
         */
        public static function returnDefaultEmailTemplateCSS()
        {
        ...
        {
            $content = SchedulerEnrollmentEmail::returnDefaultEnrollmentEmailTemplate();
            $css = SchedulerEnrollmentEmail::returnDefaultEmailTemplateCSS();
        ...
        {
            $content = isset($this->wdmwsSettings['wdmws_enrl_email_body']) ? $this->wdmwsSettings['wdmws_enrl_email_body'] : SchedulerEnrollmentEmail::defaultEmailTemplateWithCSS();
        ...
        public function trigger()
        {
         ...
         /**
         * This function is used to get enrollment email subject.
         *
         * @param string $wdmwsSettings Scheduler settings.
         *
         * @return string Subject for enrollment email.
         */
        public function getMailSubject($wdmwsSettings)
        {
            $subject = isset($wdmwsSettings['wdmws_enrl_email_sub']) ? $wdmwsSettings['wdmws_enrl_email_sub'] : __('Product enrollment successful from [site_title]', WDM_WOO_SCHED_TXT_DOMAIN);

            $siteTitle = wp_specialchars_decode(get_option('blogname'), ENT_QUOTES);
            $subject = str_replace('[site_title]', $siteTitle, $subject);

            return apply_filters('wdmws_enrollment_successful_email_subject', $subject);
        }
