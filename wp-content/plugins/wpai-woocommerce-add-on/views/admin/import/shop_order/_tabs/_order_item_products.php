								...
								<table class="form-field">
									<?php foreach ($product['meta_name'] as $j => $meta_name): if (empty($meta_name)) continue; ?>
										...
										<td style="padding-right:10px;">
											...
											<input type="text" class="short rad4" name="pmwi_order[products][<?php echo $i;?>][meta_name][]" value="<?php echo esc_attr($meta_name); ?>" style="width:100%;"/>
										</td>
										<td style="padding-left:10px;">
											<label><?php _e('Meta Value', PMWI_Plugin::TEXT_DOMAIN); ?></label>
											<input type="text" class="short rad4" name="pmwi_order[products][<?php echo $i;?>][meta_value][]" value="<?php echo esc_attr($product['meta_value'][$j]); ?>" style="width:100%;"/>
										</td>
						...
						<td colspan="2">
                            ...
                            <table class="form-field">
                                <tr class="form-field template">
                                    <td style="padding-right:10px;">
                                        <label><?php _e('Meta Name', PMWI_Plugin::TEXT_DOMAIN); ?></label>
                                        <input type="text" class="short rad4" name="pmwi_order[products][ROWNUMBER][meta_name][]" value="" style="width:100%;"/>
                                    </td>
                                    <td style="padding-left:10px;">
                                        <label><?php _e('Meta Value', PMWI_Plugin::TEXT_DOMAIN); ?></label>
                                        <input type="text" class="short rad4" name="pmwi_order[products][ROWNUMBER][meta_value][]" value="" style="width:100%;"/>
                                    </td>
                                    <td class="action remove"><a href="#remove" style="top: 33px;"></a></td>
                                </tr>
                                <tr>
