...
class Klogger{
     ...
     * @return KLogger
     */
    public static function instance($logDirectory = false, $severity = false,$filename = 'foo')
    {
        if ($severity === false) {
        ...
        self::$instances[$logDirectory] = new self($logDirectory, $severity, $filename);
     ...
     * @return void
     */
    public function __construct($logDirectory, $severity, $filename)
    {
